/**
 * retry.ts — Exponential backoff com jitter (server-side).
 *
 * Implementação espelha `src/services/_internal/retry.ts` (lado cliente)
 * para padrão idêntico em cliente e servidor.
 *
 * Princípios:
 *  - Re-tenta SOMENTE se o erro for marcado como retryable.
