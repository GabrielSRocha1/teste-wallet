    ...
    return (
        <svg width="97" height="96" viewBox="0 0 97 96" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
                ...
                >
                    <stop stopColor="#F5D771" />
                    <stop offset="0.14" stopColor="#E2C157" />
                    <stop offset="0.42" stopColor="#c9a84c" />
                    <stop offset="0.79" stopColor="#A58532" />
                    <stop offset="0.99" stopColor="#816016" />
                    <stop offset="1" stopColor="#816016" />
                </linearGradient>
                <linearGradient
