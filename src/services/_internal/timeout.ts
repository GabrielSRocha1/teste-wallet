 ...
 *
 * AbortController-aware: se a operação suportar AbortSignal, o timeout chama abort().
 */
...
/** Helper: cria um AbortSignal que dispara após `ms`. Equivalente a AbortSignal.timeout polyfill-safe. */
